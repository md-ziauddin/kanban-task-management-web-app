...
const DeleteModal = ({
  ...
  return (
    ...
    >
      {/* Delete Modal */}
      <div className="scrollbar-hide overflow-y-scroll max-w-md max-h-[95vh] my-auto bg-white dark:bg-[#25b2c37] text-black dark:text-white w-full px-8 py-8 rounded-xl">
        ...
        <div className="flex w-full mt-4 items-center justify-center space-x-4">
          <button
            ...
            className="w-full items-center cursor-pointer text-white hover:opacity-75 font-semibold bg-red-500 py-2 rounded-full"
          >
            Delete
          </button>
          <button
            onClick={() => setIsDeleteModalOpen(false)}
            className="w-full items-center cursor-pointer text-[#635fc7] hover:opacity-75 font-semibold bg-[#635fc71a] py-2 rounded-full"
          >
            Cancel
          </button>
        </div>
